...
public class EnemyLaserShreddeer : MonoBehaviour
{
    Camera Camera;
    ...
    void Start()
    {
        ...
        var middleTopCameraPos = Camera.ViewportToWorldPoint(new Vector3(0.5f, 0, 0));
    ...
    {
        if (collision.gameObject.tag.Equals("Enemy Projectile"))
        {
